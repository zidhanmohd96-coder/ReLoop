...
class ProfileTab extends StatefulWidget {
  ...
  const ProfileTab({super.key, this.onViewHistory});
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: ListView(
                children: [
                  _buildPriceRow('Newspaper', '₹15/kg', isDark),
                  _buildPriceRow('Cardboard', '₹10/kg', isDark),
                  _buildPriceRow('Books', '₹12/kg', isDark),
                  _buildPriceRow('Mixed Paper', '₹8/kg', isDark),
                  _buildPriceRow('Iron', '₹28/kg', isDark),
                  _buildPriceRow('Copper', '₹450/kg', isDark),
                  _buildPriceRow('Aluminium', '₹110/kg', isDark),
                  _buildPriceRow('E-Waste', '₹20/kg', isDark),
                ],
              ),
            ),
          ],
              ...
              child: ListView(
                children: [
                  _buildFAQItem(
                    ...
                    'Tap "Book Pickup" on the home screen, select your scrap items, choose a date and time, and confirm your location.',
                    isDark,
                  ),
                  _buildFAQItem(
                    'What items can I recycle?',
                    'We accept paper, cardboard, books, plastics, metals (iron, copper, aluminium), and e-waste.',
                    isDark,
                  ),
                  _buildFAQItem(
                    'How and when do I get paid?',
                    'Payment is immediate via UPI or cash once the pickup partner collects and weighs your scrap.',
                    isDark,
                  ),
                  _buildFAQItem(
                    'Are there any pickup charges?',
                    'No, our pickup service is completely free. You get the full value of your scrap.',
                    isDark,
                  ),
                  _buildFAQItem(
                    'How do Eco Points work?',
                    'You earn Eco Points for every pickup. Redeem them for vouchers, discounts, and exclusive rewards.',
                    isDark,
                  ),
                ],
              ),
