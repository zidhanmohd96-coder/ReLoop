          ...
          child: Stack(
            children: [
              PageView(
                ...
                physics: const NeverScrollableScrollPhysics(), // Disable swipe to keep nav bar control clean
                onPageChanged: (index) {
                  setState(() {
                    _currentIndex = index;
                  });
  ...
  Widget _buildFloatingNavBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white.withOpacity(0.9), // Slightly transparent for glass effect
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(1, LucideIcons.calendar),
          _buildNavItem(2, LucideIcons.trophy),
